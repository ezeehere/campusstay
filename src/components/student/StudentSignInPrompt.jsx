...
function StudentSignInPrompt({ listing, onClose }) {
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-950/50 px-4 py-4 sm:items-center">
      <div className="w-full max-w-lg rounded-[2rem] bg-white p-6 shadow-2xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-extrabold text-[#1F2933]">
              Sign in to view full PG details
            </h2>

            <p className="mt-2 text-sm leading-6 text-slate-500">
              Create a student account to view more details, save this listing,
              set preferences, and get better PG or room suggestions.
            </p>
          </div>
        ...
        <div className="mt-5 rounded-3xl border border-[#E8DFD2] bg-[#FFF8EF] p-4">
          <h3 className="font-extrabold text-[#1F2933]">
            {listing.name}
          </h3>
          <p className="mt-1 text-sm text-slate-500">
            {listing.area} · Starts from ₹
        ...
        <div className="mt-5 grid gap-3">
          <div className="flex gap-3 rounded-3xl bg-[#F6F1E8] p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Keep your shortlisted stays in one place.
              </p>
            </div>
          </div>

          <div className="flex gap-3 rounded-3xl bg-[#F6F1E8] p-4">
            <Sparkles className="mt-0.5 text-[#1E5B4F]" size={20} />
            <div>
              <p className="text-sm font-bold text-[#1F2933]">
                Get better suggestions
              </p>
              <p className="mt-1 text-sm text-slate-500">
                See listings based on your budget, area, food, and stay type.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3 rounded-3xl bg-[#F6F1E8] p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Logged-in students can review PGs and rooms.
              </p>
            </div>
          </div>
        </div>
...
export default StudentSignInPrompt;
