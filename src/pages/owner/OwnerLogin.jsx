...
function OwnerLogin() {
  ...
  async function handleEmailSubmit(event) {
    ...
    try {
      ...
      if (mode === "register") {
        await registerOwnerWithEmail(fullName.trim(), email.trim(), password);
      } else {
        ...
        <div className="grid w-full gap-6 lg:grid-cols-[1fr_0.9fr]">
          <section className="rounded-[2rem] bg-[#1E5B4F] p-8 text-white shadow-sm sm:p-10">
            ...
            <div className="mt-16 max-w-xl">
              <p className="flex w-fit items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-sm font-semibold text-white">
                <Building2 size={16} />
                Owner Account
              </p>

              <h1 className="mt-5 text-4xl font-extrabold leading-tight sm:text-5xl">
                Manage your PG listing and see student interest.
              </h1>

              <p className="mt-5 text-base leading-7 text-white/80">
                Owners can list PGs or rooms, check listing status, and view
                basic analytics such as views, saves, calls, and WhatsApp clicks.
              </p>
            </div>
          </section>
          ...
          <section className="rounded-[2rem] border border-[#E8DFD2] bg-white p-6 shadow-sm sm:p-8">
            ...
            <div className="mt-7">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Use this account to manage your PG or room listings.
              </p>
            </div>
